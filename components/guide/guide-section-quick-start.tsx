...
export function GuideSectionQuickStart(): React.ReactElement {
  return (
    <section id="bat-dau">
      ...
      <h3>Bước 2: Chọn mô hình AI</h3>
      <p>
        Mỗi tác vụ có thể dùng mô hình khác nhau. Xem mục{" "}
      ...
      <ul>
        <li>
          <strong>Dán link</strong>: Tổng quan &rarr; &ldquo;Thêm sản phẩm nhanh&rdquo; &rarr;
          dán link TikTok Shop hoặc FastMoss
        </li>
        <li>
          <strong>Upload file</strong>: Đồng bộ &rarr; kéo thả file XLSX từ FastMoss
        </li>
      </ul>
