...
import { Sun, Moon, LayoutDashboard, Upload, Sparkles, ShoppingBag, Megaphone, Inbox, Film, ClipboardList, Brain } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/playbook", label: "Playbook", icon: Brain },
